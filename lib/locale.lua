...
function getUserLang(msg)
	if msg.chat and chats[msg.chat.id] then 
		return chats[msg.chat.id].data.lang
	end
	return users[msg.from.id].lang or detectLanguage(msg)
end
...
function loadDefaultLanguage()
	...
	g_locale[1] = {
		...
		["global"] = "global do chat",
		["command"] = "do comando",
		["default-command-toggle-fail"] = "Falha em alternar: %s",
		["default-command-toggle-success"] = "Alternado %s para %s",
	...
	g_locale[2] = {
		...
		["default-command-toggle-fail"] = "Failed to toggle: %s",
		["default-command-toggle-success"] = "Toggled %s to %s.",
